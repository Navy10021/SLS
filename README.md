...
We find that both the embedding modelization (name it ***split-merge***) and scoring method (name it ***the multi-interactions mechanisms***) help improve semantic search accuracy by 14 – 20%. It demonstrates that they are suitable approach in neural information retrieval.
